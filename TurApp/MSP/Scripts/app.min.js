...
$(function () {
    //script para seleccionar el menu activo segun la url
    var path = window.location.pathname;
    var element = $('.treeview-menu a[href="' + path + '"]');
    if (element.length == 0) {
        // no elements have been found
        return false;
    }
    element.parent().addClass("active");
    while (!element.hasClass('sidebar')) {
...
/* Esta linea soluciona el conflicto q se produce entre el plugin "Select2" y el modal de Boostramp q no permite escribir en el buscador del selcet  https://github.com/select2/select2/issues/1436 */
$.fn.modal.Constructor.prototype.enforceFocus = function () { };

//Esta funcion sobrescribe el metodo "matcher" del control Select2 y permite ralizar busquedas en combos de seleccion agrupados por grupo
...
function modelMatcher2(term, text, opt) {
    debugger
