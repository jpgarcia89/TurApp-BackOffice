function printMapControl(n) {
    if (!isCanvasSupported()) return null;
    var t = printMapButton("Print", "printMap");
    return google.maps.event.addDomListener(t, "click", function() {
        printMap(n)
    }), t
}
...
function printMap(n) {
    var r = n.mapTypeControl,
        u = n.zoomControl,
        f = n.streetViewControl,
        e = n.panControl,
        o = n.fullscreenControl,
        t, i;
    n.setOptions({
        mapTypeControl: !1,
        zoomControl: !1,
    ...
    i = function() {
        ...
        try {
            u = [];
            r = n.getDiv();
            $(r).find("canvas").filter(function() {
                u.push(this.toDataURL("image/png"))
            });
            var f = $(r).clone(),
                e = r.clientWidth,
                o = r.clientHeight;
            if ($(f).find("canvas").each(function(n, t) {
                    $(t).replaceWith($("<img>").attr("src", u[n])).css("position", "absolute").css("left", "0").css("top", "0").css("width", e + "px").css("height", o + "px")
                }), i = window.open("", "PrintMap", "width=" + e + ",height=" + o), i == null) throw new Error("Unable to display the print dialog, you might need to allow popups on this site");
            i.document.writeln($(f).html());
            i.document.close();
            i.focus();
            i.print();
            i.close()
...
function printMapButton(n, t) {
    ...
    i.style.color = "#565656";
    i.style.cursor = "pointer";
    i.style.textAlign = "center";
    i.style.boxShadow = "rgba(0, 0, 0, 0.298039) 0 1px 4px -1px";
    u.appendChild(i);
    r = document.createElement("div");
    r.style.fontFamily = "Roboto,Arial,sans-serif";
    ...
    $(i).on("mouseenter", function() {
        i.style.backgroundColor = "rgb(235, 235, 235)";
        i.style.color = "#000"
    });
...
function numberFormatter(n, t) {
    return addCommas(parseFloat(n.toFixed(t.tickDecimals)))
}
...
function attachRowClicker() {
    $(".table-hover tr").click(function(n) {
        rowLink(n.currentTarget) != null && (window.location.href = rowLink(n.currentTarget))
    }).hover(function(n) {
        rowLink(n.currentTarget) != null && $(n.currentTarget).toggleClass("hover")
    })
}

function rowLink(n) {
    return $(n).find("a").attr("href")
}

function kmlDocumentStart(n) {
    var t = '<?xml version="1.0" encoding="UTF-8"?>\n<kml xmlns="http://www.opengis.net/kml/2.2">\n<Document>\n';
    return n != null && (t += "<name>" + n + "<\/name>"), t
}
...
function kmlStyleUrl(n) {
    return "<styleUrl>#" + n + "<\/styleUrl>"
}

function gpxStart(n) {
    var t = "http://www.garmin.com/xmlschemas/";
    return '<?xml version="1.0" encoding="UTF-8" standalone="no" ?>\n<gpx xmlns="http://www.topografix.com/GPX/1/1" xmlns:gpxx="' + t + 'GpxExtensions/v3" xmlns:gpxtpx="' + t + 'TrackPointExtension/v1" creator="Doogal.co.uk" version="1.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.topografix.com/GPX/1/1 http://www.topografix.com/GPX/1/1/gpx.xsd ' + t + "GpxExtensions/v3 " + t + "GpxExtensionsv3.xsd " + t + "TrackPointExtension/v1 " + t + 'TrackPointExtensionv1.xsd">\n<metadata>\n<link href="http://www.doogal.co.uk">\n<text>Doogal.co.uk<\/text>\n<\/link>\n<time>' + (new Date).toISOString() + "<\/time>\n<\/metadata>\n<trk>\n<name>" + n + "<\/name>\n<trkseg>\n"
}

function gpxPoint(n, t) {
    t === void 0 && (t = null);
    var i = '<trkpt lat="' + roundNumber(n.lat(), 6) + '" lon="' + roundNumber(n.lng(), 6) + '">\n';
...
function loadGoogleMaps(n, t, i, r) {
    var u, f;
    if (i === void 0 && (i = null), r === void 0 && (r = apiKey), r == null && (r = apiKey), googleMapsLoaded) {
        t();
        return
    }
    ...
    f = "https://maps.google.com/maps/api/js?v=3&key=" + r + "&callback=initGM";
    n != null && n !== "" && (f += "&libraries=" + n);
    i != null && (f += "&language=" + i);
    u.src = f;
    document.body.appendChild(u)
}

function geocodePostcode(n, t) {
    $.ajax({
        url: "GetPostcode.ashx?postcode=" + n,
        success: function(n) {
            var i = n.split("\t"),
                f, r, u;
            i.length > 2 && !isNaN(parseFloat(i[1])) && !isNaN(parseFloat(i[2])) ? (f = new google.maps.LatLng(parseFloat(i[1]), parseFloat(i[2])), r = "", i.length > 3 && (r = i[3].trim()), u = new AdministrativeInfo("", "", "", "", "", "", "", ""), i.length > 4 && (u = new AdministrativeInfo(i[4].trim(), i[5].trim(), i[6].trim(), i[7].trim(), i[8].trim(), i[9].trim(), i[10].trim(), i[11].trim())), t(f, r, u)) : t(null, null, null)
        }
    })
}

function geocodeAddress(n, t, i) {
    i === void 0 && (i = 0);
    var r = new google.maps.Geocoder;
    r.geocode({
        address: n
    }, function(r, u) {
        u === google.maps.GeocoderStatus.OVER_QUERY_LIMIT ? i === 10 ? t(null) : setTimeout(function() {
            geocodeAddress(n, t, i + 1)
        }, 500) : r && r[0] ? t(r[0].geometry.location) : t(null)
    })
}

function getPolygonLength(n) {
    for (var t = n.getPath(), r = 0, u = t.getLength(), i = 0; i < u - 1; i++) r += google.maps.geometry.spherical.computeDistanceBetween(t.getAt(i), t.getAt(i + 1));
    return r + google.maps.geometry.spherical.computeDistanceBetween(t.getAt(0), t.getAt(u - 1))
}

function getPolylineLength(n) {
    for (var i = n.getPath(), u = i.getLength(), r = 0, t = 0; t < u - 1; t++) r += google.maps.geometry.spherical.computeDistanceBetween(i.getAt(t), i.getAt(t + 1));
    return r
}

function getBounds(n) {
    var t = new google.maps.LatLngBounds;
    return n.getPath().forEach(function(n) {
        t.extend(n)
    }), t
}

function GetElevation(n, t, i) {
    getElevation(n, t, function(n) {
        if (n == null) $(i).html("Not found");
        else {
            var t = metresToFeet(n);
            $(i).html(Math.round(n) + " metres (" + Math.round(t) + " feet)")
        }
    })
}
...
function getElevation(n, t, i) {
    var f = new google.maps.ElevationService,
        r = [],
        u;
    r.push(new google.maps.LatLng(n, t));
    u = {
        locations: r
    };
    f.getElevationForLocations(u, function(n, t) {
        t === google.maps.ElevationStatus.OK ? n[0] ? i(n[0].elevation) : i(null) : i(null)
    })
}

function reverseGeocode(n, t) {
    ...
    i.geocode({
        ...
        if (i === google.maps.GeocoderStatus.OK)
            if (n) {
                for (f = !1, u = 0, e = n; u < e.length; u++)
                    if (r = e[u], r.types[0] === "street_address" || r.types[0] === "route") {
                        t(r.formatted_address, r.place_id);
                        f = !0;
                        break
                    }
                f || t(n[0].formatted_address, n[0].place_id)
            } else t("", "");
        else t("", "")
    })
}

function googleMapsHasLoaded() {
    return typeof google == "object" && typeof google.maps == "object"
}

function ReverseGeocode(n, t, i) {
    if (googleMapsHasLoaded()) {
        var r = new google.maps.LatLng(n, t);
        reverseGeocode(r, function(n) {
            $(i).html(n);
            $(i).val(n)
        })
    } else $(i).html("Google Maps not loaded"), $(i).val("Google Maps not loaded")
}

function getDirectionStatusText(n) {
    switch (n) {
...
function getAddressComponent(n, t) {
    for (var f, r, e, o, i = 0, u = n.address_components; i < u.length; i++)
        for (f = u[i], r = 0, e = f.types; r < e.length; r++)
            if (o = e[r], o === t) return f.long_name;
    return ""
}

function buildAddress(n, t) {
    return getAddressComponent(n, "street_number") + t + getAddressComponent(n, "route") + t + getAddressComponent(n, "locality") + t + getAddressComponent(n, "postal_town") + t + getAddressComponent(n, "administrative_area_level_3") + t + getAddressComponent(n, "administrative_area_level_2") + t + getAddressComponent(n, "administrative_area_level_1") + t + getAddressComponent(n, "postal_code") + t + getAddressComponent(n, "country")
}

function getPlaceDetails(n, t, i) {
    var r = {
            reference: t
        },
        u = new google.maps.places.PlacesService(n);
    u.getDetails(r, function(n, t) {
        var r = "";
        t === google.maps.places.PlacesServiceStatus.OK ? (r += "<table>", r += "<tr><td><b>Name<\/b><\/td><td>" + n.name + "<\/td><\/tr>", r += "<tr><td><b>Address<\/b><\/td><td>" + n.formatted_address + "<\/td><\/tr>", n.formatted_phone_number != null && (r += "<tr><td><b>Phone<\/b><\/td><td>" + n.formatted_phone_number + "<\/td><\/tr>"), n.website != null && (r += '<tr><td><b>Website<\/b><\/td><td><a href="' + n.website + '" target="_blank">' + n.website + "<\/a><\/td><\/tr>"), n.rating != null && (r += "<tr><td><b>Rating<\/b><\/td><td>" + n.rating + "<\/td><\/tr>"), r += "<\/table>") : r = "Error - " + t;
        i(r)
    })
}

function metresToFeet(n) {
    return n * 3.2808399
}

function feetToMetres(n) {
    return n / 3.2808399
}

function kmToMiles(n) {
    return n * .621371192
}

function milesToKMs(n) {
    return n / .621371192
}

function distanceUnitName(n) {
    return n ? " miles" : " km"
}

function elevationUnits(n) {
    return n ? " feet" : " metres"
}

function showDistance(n) {
    return roundNumber(n / 1e3, 1) + " km (" + roundNumber(kmToMiles(n / 1e3), 1) + " miles)"
}

function showElevation(n) {
    return addCommas(roundNumber(n, 0)) + " metres (" + addCommas(roundNumber(metresToFeet(n), 0)) + " feet)"
}
...
function moveScroller() {
    var i = $("#scroller-anchor"),
        n = $("#CriteoAdLeft"),
        t;
    n.length > 0 && (t = function() {
...
function loadDisqus() {
    var n, t;
    dsLoaded || (n = $("#disqus_thread").offset(), n == null ? reallyLoadDisqus() : (t = n.top, $(window).scrollTop() + $(window).height() > t && reallyLoadDisqus()))
}

function reallyLoadDisqus() {
    var r = $("#disqus_thread").data(),
        n, t, i;
    dsLoaded = !0;
    for (n in r) n.substr(0, 6) === "disqus" && (window["disqus_" + n.replace("disqus", "").toLowerCase()] = r[n]);
    t = document;
    i = t.createElement("script");
    i.src = "//doogal.disqus.com/embed.js";
    i.setAttribute("data-timestamp", (new Date).toString());
...
function XmlEncode(n) {
    return n = n.replace(/&/g, "&amp;"), n = n.replace(/\"/g, "&quot;"), n = n.replace(/\'/g, "&apos;"), n = n.replace(/</g, "&lt;"), n.replace(/>/g, "&gt;")
}

function getWhat3Words(n, t) {
    $.get("https://api.what3words.com/v2/reverse?key=0HZ96SU9&coords=" + n.lat() + "," + n.lng(), function(n) {
        t(n.words)
    })
}

function geolocateUser(n, t) {
    var i = 1e4,
    ...
    navigator.geolocation ? navigator.geolocation.getCurrentPosition(function(t) {
        ...
        clearTimeout(r);
        lastPos == null ? t() : n(lastPos)
    }, {
        timeout: i
    }) : t()
}

function geolocateUserOrDefault(n) {
    geolocateUser(function(t) {
        var i = new google.maps.LatLng(t.coords.latitude, t.coords.longitude);
        n(i)
    }, function() {
        n(new google.maps.LatLng(54.559322, -4.174804))
    })
}

function showError(n) {
    $("#error-modal .modal-body").html(n);
    $("#error-modal").modal()
}
...
function latLngInUk(n) {
    return n.lat() > 49 && n.lat() < 61 && n.lng() > -12 && n.lng() < 3
}

function getNearestStation(n, t) {
    n.html("Thinking...");
    latLngInUk(t) ? $.get({
        url: "GetNearestStation.ashx?lat=" + t.lat() + "&lng=" + t.lng(),
        success: function(t) {
            n.html(t)
        },
...
function loadSettings(n) {
    try {
        ...
        t != null && ($("select").each(function(n, i) {
            var r = i.getAttribute("id"),
                u = t[r];
            u != null && $("#" + r).val(u)
        }), $("input[type='checkbox'], input[type='radio']").each(function(n, i) {
            var r = i.getAttribute("id"),
                u = t[r];
            u === "on" ? $("#" + r).attr("checked", "true") : u === "off" && i.removeAttribute("checked")
        }))
    } catch (i) {}
}
...
function saveSettings(n) {
    try {
        var t = {};
        $("select").each(function(n, i) {
            var r = i.getAttribute("id");
            t[r] = $("#" + r).val()
        });
        $("input[type='checkbox'], input[type='radio']").each(function(n, i) {
            t[i.getAttribute("id")] = $(i).is(":checked") ? "on" : "off"
        });
...
function getGestureHandling() {
    return isTouchDevice() ? "cooperative" : "greedy"
}

function getMarkerSpacing(n) {
    return n > 5e4 ? 10 : n > 2e4 ? 5 : 1
}

function addDistanceMarkers(n, t) {
    for (var r, u, f, e, o = 0, i = 1; i < t.length; i++) r = t[i - 1], u = t[i], o += google.maps.geometry.spherical.computeDistanceBetween(r, u);
    for (f = getMarkerSpacing(o), e = 0, i = 1; i < t.length; i++) {
        var r = t[i - 1],
            u = t[i],
            s = google.maps.geometry.spherical.computeDistanceBetween(r, u),
            c = e;
        if (e += s / 1e3, e > f) {
            var h = (f - c) / (s / 1e3),
                l = r.lat() + (u.lat() - r.lat()) * h,
                a = r.lng() + (u.lng() - r.lng()) * h,
                v = new google.maps.Marker({
                    position: new google.maps.LatLng(l, a),
                    map: n,
                    label: f.toString(),
                    zIndex: 10,
                    icon: {
                        url: "images/station3.png",
                        anchor: new google.maps.Point(10, 10)
                    }
                });
            f += getMarkerSpacing(o)
        }
    }
}
var cookieChoices = function() {
        function n() {}
        return n.showCookieConsentBar = function(n, t) {
            var s = "displayCookieConsent",
                f = "cookieChoiceInfo",
                h = "cookieChoiceDismiss",
                i, e, r, u, o;
            document.cookie.match(new RegExp(s + "=([^;]+)")) || ($("#" + f).remove(), i = document.createElement("div"), i.id = f, i.style.cssText = "position:fixed;width:100%;background-color:#000;color:#fff;margin:0; left:0; top:0;padding:10px;z-index:1000;text-align:center;font-size: 20px;", e = document.createElement("span"), $(e).text("This site uses cookies"), i.appendChild(e), !n || !t || (r = document.createElement("a"), $(r).text(n), r.href = t, r.target = "_blank", r.style.marginLeft = "8px", i.appendChild(r)), u = document.createElement("a"), $(u).text("close message"), u.id = h, u.href = "#", u.style.marginLeft = "24px", i.appendChild(u), o = document.createDocumentFragment(), o.appendChild(i), document.body != null && (document.body.appendChild(o.cloneNode(!0)), $("#" + h).click(function() {
                var n = new Date;
                return n.setFullYear(n.getFullYear() + 1), document.cookie = s + "=y; expires=" + n.toUTCString(), $("#" + f).remove(), !1
            })))
        }, n
    }(),
    ErrorHandler, Point, googleMapsLoaded, apiKey, AdministrativeInfo, dsLoaded, lastPos, sorttable;
...
ErrorHandler = function() {
    ...
    return n.prototype.submitError = function() {
        var n = "(no stack trace)";
        this.errorObj != null && (n = this.errorObj.stack);
        $.ajax({
            type: "POST",
            url: "LogError.ashx",
            data: JSON.stringify({
                ...
                error: this.errorMsg,
                script: this.errorUrl,
                line: this.errorLineNumber,
                stack: n
            }),
...
dsLoaded = !1;
$(document).ready(function() {
    inIframe() || cookieChoices.showCookieConsentBar("learn more", "cookies.php")
});
lastPos = null;
sorttable = function() {
    function n() {}
    return n.init = function() {
        this.done || (this.done = !0, $("table.sortable").each(function(t, i) {
            n.makeSortable(i)
        }))
    }, n.makeSortable = function(t) {
        var e, r, i, u, f;
        if (t.getElementsByTagName("thead").length === 0 && (e = document.createElement("thead"), e.appendChild(t.rows[0]), t.insertBefore(e, t.firstChild)), t.tHead == null && (t.tHead = t.getElementsByTagName("thead")[0]), t.tHead.rows.length === 1)
            for (r = t.tHead.rows[0].cells, i = 0; i < r.length; i++)
                if (!$(r[i]).hasClass("sorttable_nosort")) {
                    u = "";
                    f = r[i].className.match(/\bsorttable_([a-z0-9]+)\b/);
                    f && (u = f[1]);
                    r[i].sorttable_sortfunction = f && typeof n["sort_" + u] == "function" ? n["sort_" + u] : n.guessType(t, i);
                    r[i].sorttable_columnindex = i;
                    r[i].sorttable_tbody = t.tBodies[0];
                    $(r[i]).on("click", n.innerSortFunction)
                }
    }, n.innerSortFunction = function(t) {
        var i = t.currentTarget,
            o, f, s, u, c, e;
        if ($("#sorttable_sortfwdind").remove(), $(i).hasClass("sorttable_sorted")) {
            n.reverse(i.sorttable_tbody);
            $(i).removeClass("sorttable_sorted").addClass("sorttable_sorted_reverse");
            n.addSortIconInternal(i, "&#x25BE;");
            return
        }
        if ($(i).hasClass("sorttable_sorted_reverse")) {
            n.reverse(i.sorttable_tbody);
            $(i).removeClass("sorttable_sorted_reverse").addClass("sorttable_sorted");
            n.addSortIcon(i);
            return
        }
        for (o = i.parentNode, f = 0; f < o.childNodes.length; f++) s = o.childNodes[f], s.nodeType === 1 && $(s).removeClass("sorttable_sorted_reverse sorttable_sorted");
        $(i).addClass("sorttable_sorted");
        n.addSortIcon(i);
        var r = [],
            l = i.sorttable_columnindex,
            h = i.sorttable_tbody.rows;
        for (u = 0; u < h.length; u++) r[r.length] = [n.getInnerText(h[u].cells[l]), h[u]];
        for (r.sort(i.sorttable_sortfunction), c = i.sorttable_tbody, e = 0; e < r.length; e++) c.appendChild(r[e][1])
    }, n.addSortIconInternal = function(n, t) {
        var i = document.createElement("span");
        i.id = "sorttable_sortfwdind";
        i.innerHTML = "&nbsp;" + t;
        n.appendChild(i)
    }, n.addSortIcon = function(n) {
        this.addSortIconInternal(n, "&#x25B4;")
    }, n.guessType = function(t, i) {
        for (var r, u, o, s, e = n.sort_alpha, f = 0; f < t.tBodies[0].rows.length; f++)
            if (r = n.getInnerText(t.tBodies[0].rows[f].cells[i]), r !== "") {
                if (r.match(/^-?[£$¤]?[\d,.]+%?$/)) return n.sort_numeric;
                if (u = r.match(n.DATE_RE), u) {
                    if (o = parseInt(u[1], 10), s = parseInt(u[2], 10), o > 12) return n.sort_ddmm;
                    if (s > 12) return n.sort_mmdd;
                    e = n.sort_ddmm
                }
            }
        return e
    }, n.getInnerText = function(t) {
        var i, u, r;
        if (!t) return "";
        if (i = t.getElementsByTagName("input").length > 0, t.getAttribute("sorttable_customkey") != null) return t.getAttribute("sorttable_customkey");
        if (typeof t.textContent == "undefined" || i)
            if (typeof t.innerText == "undefined" || i)
                if (typeof t.text == "undefined" || i) switch (t.nodeType) {
                    case 3:
                        if (t.nodeName.toLowerCase() === "input") return t.value.replace(/^\s+|\s+$/g, "");
                    case 4:
                        return t.nodeValue.replace(/^\s+|\s+$/g, "");
                    case 1:
                    case 11:
                        for (u = "", r = 0; r < t.childNodes.length; r++) u += n.getInnerText(t.childNodes[r]);
                        return u.replace(/^\s+|\s+$/g, "");
                    default:
                        return ""
                } else return t.text.replace(/^\s+|\s+$/g, "");
                else return t.innerText.replace(/^\s+|\s+$/g, "");
        else return t.textContent.replace(/^\s+|\s+$/g, "")
    }, n.reverse = function(n) {
        for (var i, t = [], r = 0; r < n.rows.length; r++) t[t.length] = n.rows[r];
        for (i = t.length - 1; i >= 0; i--) n.appendChild(t[i])
    }, n.sort_numeric = function(n, t) {
        var r = parseFloat(n[0].replace(/[^0-9.-]/g, "")),
            i;
        return isNaN(r) && (r = 0), i = parseFloat(t[0].replace(/[^0-9.-]/g, "")), isNaN(i) && (i = 0), r - i
    }, n.sort_alpha = function(n, t) {
        return n[0] === t[0] ? 0 : n[0] < t[0] ? -1 : 1
    }, n.sort_ddmm = function(t, i) {
        var f = t[0].match(n.DATE_RE),
            e = f[3],
            r = f[2],
            u = f[1],
            o, s;
        return (r.length === 1 && (r = "0" + r), u.length === 1 && (u = "0" + u), o = e + r + u, f = i[0].match(n.DATE_RE), e = f[3], r = f[2], u = f[1], r.length === 1 && (r = "0" + r), u.length === 1 && (u = "0" + u), s = e + r + u, o === s) ? 0 : o < s ? -1 : 1
    }, n.sort_mmdd = function(t, i) {
        var f = t[0].match(n.DATE_RE),
            e = f[3],
            r = f[2],
            u = f[1],
            o, s;
        return (u.length === 1 && (u = "0" + u), r.length === 1 && (r = "0" + r), o = e + u + r, f = i[0].match(n.DATE_RE), e = f[3], r = f[2], u = f[1], u.length === 1 && (u = "0" + u), r.length === 1 && (r = "0" + r), s = e + u + r, o === s) ? 0 : o < s ? -1 : 1
    }, n.DATE_RE = /^(\d\d?)[\/\.-](\d\d?)[\/\.-]((\d\d)?\d\d)$/, n.done = !1, n
}();
$(document).ready(function() {
    sorttable.init()
});